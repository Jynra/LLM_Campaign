...
const CONFIG = {
	...
	api: {
		baseUrl: 'https://api.example.com/roleplay',
		endpoints: {
			sendMessage: '/message',
			getHistory: '/history',
			rollDice: '/dice',
	...
	game: {
		...
		refreshInterval: 3000,  // Intervalle de rafraîchissement en ms
		maxHistoryMessages: 50  // Nombre maximum de messages à conserver dans l'historique
	},
